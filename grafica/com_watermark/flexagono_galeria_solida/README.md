# Flexágono Galeria Matemática de Cores Sólidas
...
- **Painel dos Planos Ômega (a mesma codificação de cada face, aplicada à identidade $f(z)=z$ — sem compor com nenhuma função):** [`painel_omega_GaleriaSolida.png`](painel_omega_GaleriaSolida.png)
...
- **Diagrama de Dinâmica, faces 3↔5 e 4↔6 trocadas (mesma disposição do plano de impressão físico deste flexágono):** [`Diagrama_Dinamica_GaleriaSolida_trocado.png`](Diagrama_Dinamica_GaleriaSolida_trocado.png)
